      ...
      //      String url="jdbc:mysql://54.255.202.138:3306/founderdb";
            try{
                ...
                if(reals.equals("houses_cn")){
                    sql="select id,type,name,keyword,sintro,intro,detail,fac,price,price_des,img,img_d,housemap,created,display from houses where type='Houses' and enable='1' order by created desc";
